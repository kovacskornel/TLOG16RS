...
public class Task {
     ...
     * @return boolean<br>true if it is a valid redmine ID<br>false if it is not
     * a valid redmine
     */
     ...
     *
     * @param id Gets the ID from user input
     * @return boolean<br>true if it is a valid LT task ID<br>false if it is not
     * a valid LT task
     */
     ...
     *
     * @param id Gets the ID from user input
     * @return boolean<br>true if it is a valid redmine or LT task ID<br>false
     * if it is not a valid redmine or LT task
     */
     ...
     * @exception EmptyTimeFieldException if the user leaves the time field
     * empty
     */
    public final void setStartTime(LocalTime startTime) {
        if (startTime.getHour() != 0 || startTime.getMinute() != 0) {
            ...
            throw new EmptyTimeFieldException("Empty start time!");
        }
    }
    ...
    public final void setEndTime(LocalTime endTime) {
        ...
        if (endTime.getHour() != 0 || endTime.getMinute() != 0) {
            ...
            throw new EmptyTimeFieldException("Empty end time!");
        }
